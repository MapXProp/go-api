...
func SetupRoutes(app *fiber.App, db *sql.DB) {
	...
	api.Get("/me/saved-listings", handlers.GetMySavedListings(db))
	api.Post("/me/saved-listings/merge", handlers.MergeMySavedListings(db))
	api.Put("/me/saved-listings/:identifier", handlers.SaveMyListing(db))
	api.Delete("/me/saved-listings/:identifier", handlers.UnsaveMyListing(db))
