...
func SetupRoutes(app *fiber.App, db *sql.DB) {
	...
	api.Get("/me/search-history", handlers.MySearchHistory(db))
	api.Post("/me/search-history", handlers.MySearchHistory(db))
	api.Delete("/me/search-history", handlers.MySearchHistory(db))
	...
	api.Get("/me/organizations", handlers.GetMyOrganizations(db))
	api.Get("/organizations", handlers.ListOrganizations(db))
	api.Post("/organizations", handlers.CreateOrganization(db))
	api.Get("/organizations/:publicOrganizationID/listings", handlers.GetOrganizationListings(db))
	api.Get("/organizations/:publicOrganizationID", handlers.GetOrganization(db))
	api.Patch("/organizations/:publicOrganizationID", handlers.UpdateOrganization(db))
	api.Put("/organizations/:publicOrganizationID/contacts", handlers.UpdateOrganizationContacts(db))
	api.Get("/organizations/:publicOrganizationID/members", handlers.GetOrganizationMembers(db))
	api.Post("/organizations/:publicOrganizationID/invitations", handlers.InviteOrganizationMember(db))
	api.Get("/organizations/:publicOrganizationID/invitations", handlers.GetOrganizationInvitations(db))
	api.Patch("/organizations/:publicOrganizationID/members/:publicUserID", handlers.UpdateOrganizationMember(db))
	...
	api.Patch("/admin/organizations/:publicOrganizationID/verification", handlers.VerifyOrganization(db))
